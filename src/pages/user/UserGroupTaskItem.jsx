      ...
      {editingTaskId === task.id ? (
        ...
        <>
          ...
          <div className="mb-3 mt-1">
            ...
            {/* Group Name */}
            {task.teamName && (
              <p className={`text-xs font-medium mb-2 ${darkMode ? "text-indigo-400" : "text-indigo-600"}`}>
                📁 {task.teamName}
              </p>
            )}
            
            {/* Status Badge with Icon and Custom Tag */}
            <div className="flex items-center gap-2 flex-wrap">
              ...
              {/* Custom Task Badge - shown when no team name */}
              {!task.teamName && (

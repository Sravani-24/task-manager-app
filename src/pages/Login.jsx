...
import { Mail, Lock, ArrowRight, CheckCircle2, Users, Zap } from "lucide-react";
      ...
      <div className={`hidden lg:flex lg:w-1/2 relative overflow-hidden ${
        ...
        <div className="relative z-10 flex flex-col justify-center px-16 text-white">
          <div className="mb-8">
            ...
            <p className="text-xl text-blue-100 mb-8 animate-slideUp" style={{ animationDelay: '0.1s' }}>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-start gap-4 animate-slideUp" style={{ animationDelay: '0.3s' }}>
              ...
              <div>
                ...
                <p className="text-blue-100 text-sm">Organize teams and assign tasks efficiently</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 animate-slideUp" style={{ animationDelay: '0.4s' }}>
              ...
              <div>
                ...
                <p className="text-blue-100 text-sm">Monitor task completion and team performance</p>
              </div>
            </div>
          </div>
        </div>
